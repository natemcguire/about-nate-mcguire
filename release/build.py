...
urls=['https://natemcguire.com/','https://natemcguire.com/author']+[f'https://natemcguire.com/author/{p.stem}' for p in sorted((ROOT/'v2/author').glob('*.html'))]
