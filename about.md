...
- **Mayven Studios** – Founded premier engineering & design agency serving top Silicon Valley brands. Acquired by **Saltwater** (Ryan Graves' family office) in 2022
- **Recipeas** – iOS recipe generator app. **#2** free food and drink app
- **PureCalculators.com** – Acquired technical content platform from Finnish entrepreneur
- **austintaxrateelection.com** – Built informational site that helped defeat Austin's $110M Prop Q tax increase (2024)
...
- Founded and sold **Mayven Studios** to **Saltwater** (Ryan Graves / Uber)
- Built **austintaxrateelection.com** for $2, helping defeat a **$110M tax increase** with 63% of the vote
- Launched **Recipeas**, an iOS recipe generator (#2 free food & drink app)
...
- A leadership philosophy contrasting high-accountability, results-driven management with overprotective leadership styles
...
- [KUT (NPR): Website against Austin Prop Q raises ethics questions](https://www.kut.org/austin/2024-10-18/proposition-q-property-tax-rate-election-ethics-complaint)
- [KXAN: Love Austin withdraws ethics complaint against anti-Prop Q website](https://www.kxan.com/news/local/austin/love-austin-campaign-withdraws-ethics-complaint-against-anti-prop-q-website/)
- [Austin Chronicle: The Prop Q Debate Has Entered the 'Silly Season'](https://www.austinchronicle.com/news/2024-10-25/the-prop-q-debate-has-entered-the-silly-season/)
- [LivTX: Christmas came early thanks to a guy named Nate](https://livtx.com/blog/christmas-came-early-thanks-to-a-guy-named-nate)
...
- [TDD for Today's Engineering Teams](https://mayvenstudios.com/blog/tdd-todays-engineering-teams-test-driven-development)
- [Embracing Microservices Architecture for Large Enterprises](https://mayvenstudios.com/blog/embracing-microservices-architecture-large-enterprises-key-insights-benefits)
- [Designing Effective REST APIs](https://mayvenstudios.com/blog/designing-effective-rest-apis-guide-software-developers)
...
- Advisor to early-stage companies on **engineering hiring**, **technical strategy**, and **product development**
- Worked with top VC firms like **Andreessen Horowitz** & **Lightspeed** on engineering & product initiatives
